package com.phj.opengl.shape.square;
...
/**
 * 描述：采用glDrawElements 方式绘制三角形
 * Created by PHJ on 2019/7/10.
 */

public class ElementSquareRender implements GLSurfaceView.Renderer {

    private final static String TAG = ElementSquareRender.class.getSimpleName();
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //绘制三角形
        GLES20.glDrawElements(GLES20.GL_TRIANGLE_STRIP, 4,GLES20.GL_UNSIGNED_SHORT,indiceBuffer);
        //禁止顶点数组的句柄
