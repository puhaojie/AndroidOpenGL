...
/**
 * 描述：采用glDrawArrays#GL_TRIANGLE_STRIP方式绘制三角形
 * Created by PHJ on 2019/7/10.
 */

public class DefaultTriggerRender implements GLSurfaceView.Renderer {

    private final static String TAG = DefaultTriggerRender.class.getSimpleName();
