...
/**
 * 描述：采用VBO + glDrawArrays#GL_TRIANGLE_STRIP方式绘制三角形
 * Created by PHJ on 2019/7/10.
 */

public class VBOTriggerRender implements GLSurfaceView.Renderer {

    private final static String TAG = VBOTriggerRender.class.getSimpleName();
